...
import {
  Title, Button, SimpleGrid, Card, Text, Badge, Group, Stack,
  Modal, TextInput, Textarea, Select, Skeleton, ActionIcon,
  Alert, Center, Box,
} from '@mantine/core';
import { IconPlus, IconPencil, IconTrash, IconAlertCircle, IconCalendarEvent } from '@tabler/icons-react';
